...
def is_valid_walk(walk)
  # 4 possibles directions: north, south, east and west
  # 2 conditions to be true
    # -For each pair of block, it should return to starting point, so 1 min north == south and 1 min east == west, so we count n and s and e and west
    # -Length should be 10, if more or less then ->false
